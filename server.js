...
// YouTube
// ───────────────────────────────────────
app.get('/api/yts/searchAll', (req, res) =>
  proxy(
...
app.get('/api/yts/searchVideos', (req, res) =>
  proxy(
...
app.get('/api/yts/getVideo', (req, res) =>
  proxy(
...
app.get('/api/yts/getPlaylist', (req, res) =>
  proxy(
...
app.get('/api/yts/channelVideos', (req, res) =>
  proxy(
...
// SoundCloud
// ───────────────────────────────────────
app.get('/api/soundcloud/search', (req, res) =>
  proxy(
...
app.get('/api/soundcloud/download', (req, res) =>
  proxy(
...
// Deezer
// ───────────────────────────────────────
app.get('/api/deezer/deezer', (req, res) =>
  proxy(
...
app.get('/api/deezer/track', (req, res) =>
  proxy(
...
// MusicBrainz
// ───────────────────────────────────────
app.get('/api/musicbrainz/albums', (req, res) =>
  proxy(
...
app.get('/api/musicbrainz/artist', (req, res) =>
  proxy(
...
app.get('/api/musicbrainz/artists', (req, res) =>
  proxy(
    `https://api.qasimdev.dpdns.org/api/musicbrainz/artists?query=${req.query.query || req.query.q || ''}&apiKey=${API_KEY}`,
    'MB artists', req, res
  )
);

app.get('/api/musicbrainz/tracks', (req, res) =>
  proxy(
    `https://api.qasimdev.dpdns.org/api/musicbrainz/tracks?query=${req.query.query || req.query.q || ''}&apiKey=${API_KEY}`,
    'MB tracks', req, res
  )
);
...
// Jamendo
// ───────────────────────────────────────
app.get('/api/jamendo/albumTracks', (req, res) =>
  proxy(
...
// Loaderto Download
// ───────────────────────────────────────
app.get('/api/loaderto/download', (req, res) =>
  proxy(
